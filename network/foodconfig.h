...
class FoodConfig : public QObject
{
    ...
    Q_PROPERTY(QStringList itemIndex READ getItemIndex WRITE setItemIndex NOTIFY itemIndexChanged)
...
public:
    ...
    QStringList getItemIndex() const;
    void setItemIndex(const QStringList &value);
